...
<nav class="navbar navbar-expand-lg navbar-light bg-custom">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0">
      <button class="btn btn-dark my-2 my-sm-0" type="submit"><i class="fa-solid fa-gears"></i> Setting</button>
      <button class="btn btn-dark my-2 my-sm-0 ml-1" type="submit"><i class="fa-regular fa-id-badge"></i> Contact Us</button>
    </form>
  </div>
</nav>
